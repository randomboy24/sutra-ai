				...
				<div className="mx-auto space-y-4 sm:w-sm">
					...
					<div className="flex flex-col space-y-1">
						...
						<p className="text-base text-muted-foreground">
							login or create your Sutra AI account.
						</p>
					</div>
					<div className="space-y-2">
						<Button variant="outline" className="w-full flex items-center justify-center gap-2 cursor-pointer h-10 hover:bg-muted/50 transition-colors">
							<GoogleIcon className="h-4 w-4 shrink-0 text-foreground" />
					...
					<form className="space-y-2">
						...
						<Button className="w-full h-10 cursor-pointer" type="button">
							Continue With Email
						</Button>
					</form>
