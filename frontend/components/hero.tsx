	...
	return (
		<section className="mx-auto w-full max-w-5xl overflow-hidden pt-16">
			...
			<div className="relative z-10 flex max-w-2xl flex-col gap-5 px-4">
				<div className="flex flex-col gap-4 sm:flex-row sm:items-center">
					...
					>
						<div className="rounded-xs border bg-card px-1.5 py-0.5 shadow-sm">
							<p className="font-mono text-xs text-purple-400">BOARD</p>
						</div>

						<span className="text-xs">CBSE, ICSE, Gujarat & State Board Aligned</span>
					...
					<div className="fade-in slide-in-from-bottom-10 animate-in fill-mode-backwards delay-500 duration-500 ease-out">
						<AvatarStackDemo />
					</div>
				</div>
				...
				>
					The Autonomous AI Academic Copilot
				</h1>
				...
				>
					Sutra AI continuously monitors, diagnoses, plans, evaluates, and intervenes to automatically improve student performance 24/7.
				</p>
